...
import cv2 # This Library is use in sensor detection code 
import speech_recognition as sr      # Speech Recognition Library used for Listening Recording and More
import pyttsx3    # It will use in sepak text in audio
import time   #  it will use to presnt current time
...
#-----------------------------------------------This is Sensor Code it will detect Person Function-----------------------------------------------------------#
...
def main():
    ...
    print("AI Chatbot: Hello! Welcome to the IdeaLab.")
    speak("Hello! Welcome to the IdeaLab.", engine)
    speak("Can i help you.", engine)
...
#---------------------------------------------It will our question Block That We can Write More Question in it as Our Requirement-------------------------------------------------------------#
...
#-----------------------------------------------It will run the Question block by starting index 0 it means First Question-----------------------------------------------------------#



    
    question_index = 0  # Start with the first question




#-------------------------------------------------------It is Camera Open Function and Face Detection Function---------------------------------------------------#
    ...
    while True:
        ...
        if face_detected_frames >= frames_to_confirm:
            ...
            # If you want that ai will speak but said to him uncomment the speak block that has been lower down
